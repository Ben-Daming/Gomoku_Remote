...
## 2025.11.28 04:34
#### 新增内容
- 应用了位运算，按位运算理论上比访问数组能快，抛弃了哈希表。
- 给三三禁手做了剪枝，本来是同时判断四四、三三禁手，现在是先判断法没发生四四，如果发生了四四就不往下算三三禁手了。
- 开发了一个debug模式，专门测试禁手，测试效率提高了很多。效果图如下：
![三三禁手1](Fig/test1.png)
![禁手2](Fig/test2.png)
第二张图带来了意外收获，下在H10时黑棋L10处未解禁，因为我当时觉得没必要给冲四加长连判断，但是实践告诉我这样还是有问题。所以我又回去给四加上了眠四判断。
修改完后，l10成功解禁：
![三三禁手解禁](Fig/test3.png)
继续测试四四禁手，没有发现问题：
![四四禁手1](Fig/test4.png)
![四四禁手2](Fig/test5.png)
现在应该就没有什么好优化的方向了，这个分支任务已完成。
