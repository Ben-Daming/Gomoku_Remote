/*
                         ...
                         o         o           o           o__ __o     o__ __o  \o       o/ 
                        <|>       <|>         <|>         <|     v\   <|     v\  v\     /v  
                        < >       < >         / \         / \     <\  / \     <\  <\   />   
                         |         |        o/   \o       \o/     o/  \o/     o/    \o/     
                         o__/_ _\__o       <|__ __|>       |__  _<|/   |__  _<|/     |      
                         |         |       /       \       |           |            / \     
                        <o>       <o>    o/         \o    <o>         <o>           \o/     
                         |         |    /v           v\    |           |             |      
                        / \       / \  />             <\  / \         / \           / \     
                     ...
                     /v     v\                                                <|>                  
                    />       <\                                               / \                  
                  o/                 o__ __o    \o__ __o__ __o    o       o   \o/  o/   o       o  
                 <|       _\__o__   /v     v\    |     |     |>  <|>     <|>   |  /v   <|>     <|> 
                  \\          |    />       <\  / \   / \   / \  < >     < >  / \/>    < >     < > 
                    \         /    \         /  \o/   \o/   \o/   |       |   \o/\o     |       |  
                     o       o      o       o    |     |     |    o       o    |  v\    o       o  
...
int parseCoord(const char *str, int *row, int *col) {
    ...
    *col = colChar - 'A';
    *row = BOARD_SIZE - rowVal; // 根据给定的棋盘编码，15 是 row 0
    return 1;
}
